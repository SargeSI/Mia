...
- **Ложные переключения на нейтральных сообщениях** («Привет», «Давай», «Как дела?»): см. трёхслойную защиту — `references/three-layer-guard.md`. Фильтр: стоп-словарь → дисперсия эмбеддинга → штатный recall.
...
## Защита от ложных переключений (трёхслойная, реализована 31.05.2026)
